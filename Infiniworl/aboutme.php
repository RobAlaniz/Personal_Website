...
$mustache = new Mustache_Engine;
    ...
    $body = file_get_contents('templates/aboutme.html');
    $footer = file_get_contents('templates/footer.html');


    $header_data = ["pagetitle" => "About Me"];

    $body_data = ["pagebody" => "" , "body" => "body"];
    
    $footer_data = ["localtime" => date('l jS \of F Y h:i:s A'), "footertitle" => "The life of Robert Roboto's"];
